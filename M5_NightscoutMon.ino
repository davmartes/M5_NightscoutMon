...
void sndAlarm() {
    ...
    M5.Speaker.mute();
    // M5.Speaker.playMusic(m5stack_startup_music, 5000);        
    // M5.Speaker.update();
}
...
void drawMiniGraph() {
  ...
  */
  ...
  M5.Lcd.drawLine(195, 115, 309, 115, TFT_RED);                                                     // TOP LINE
  M5.Lcd.drawLine(185, 125, 319, 125, TFT_YELLOW);                                                  // HIGH URGENT LINE
  M5.Lcd.drawLine(185, 135, 319, 135, TFT_GREEN);                                                   // GREEN ZONE LINE
  M5.Lcd.drawLine(185, 145, 319, 145, TFT_GREEN);                                                   // GREEN ZONE LINE
  M5.Lcd.drawLine(185, 155, 319, 155, TFT_GREEN);                                                   // GREEN ZONE LINE
  M5.Lcd.drawLine(185, 165, 319, 165, TFT_GREEN);                                                   // GREEN ZONE LINE
  M5.Lcd.drawLine(185, 175, 319, 175, TFT_GREEN);                                                   // TARGET LINE
  M5.Lcd.drawLine(185, 185, 319, 185, TFT_GREEN);                                                   // RED ZONE LINE
  M5.Lcd.drawLine(185, 195, 319, 195, TFT_GREEN);                                                   // RED ZONE LINE
  M5.Lcd.drawLine(185, 205, 319, 205, TFT_RED);                                                     // LOW LINE
  M5.Lcd.drawLine(195, 215, 309, 215, TFT_MAGENTA);                                                 // MAGENTA ZONE LINE
...
//  M5.Lcd.drawLine(185, 230, 319, 230, TFT_MAGENTA);                                               // BOTTOM LINE
  ...
  for (i = 9; i >= 0; i--) {
    ...
    M5.Lcd.fillCircle(189 + i * 14, 203 - (glk - 3.0) * 10.0, 3, sgvColor);   // (x start + i * separation, y - (glk - 3.0) * 10.0, radius, color)
  }
  Serial.println();
}
...
// CLOCK SECTION
          ...
          if(cfg.show_current_time) {
            ...
            sprintf(datetimeStr, "%02d:%02d", sensTm.tm_hour, sensTm.tm_min);
          }
...
// DELTA SECTION
          ...
          M5.Lcd.fillRoundRect(0, 55, 200, 100, 0, TFT_BLACK);      // MASK RECTANGLE  (x, y, widht, height, corner)
          M5.Lcd.setFreeFont(FSSB18);
          M5.Lcd.setTextSize(2);
          M5.Lcd.setTextColor(TFT_WHITE, TFT_BLACK);
          char diffstr[10];
          ...
          M5.Lcd.drawString(diffstr, -20, 55, GFXFF);
...
//          struct tm timeinfo;
          ...
          M5.Lcd.fillRoundRect(185, 0, 135, 100, 25, tdColor);          // RECTANGLE  (x, y, widht, height, corner)
          M5.Lcd.fillRoundRect(185, 101, 135, 12, 0, TFT_BLACK);        // MASK RECTANGLE
          M5.Lcd.setTextSize(2);
          M5.Lcd.setFreeFont(FMB24);
          M5.Lcd.setTextDatum(MC_DATUM);
          M5.Lcd.setTextColor(TFT_BLACK);
          if (sensorDifMin > 99) {
            M5.Lcd.drawString("XX", 252, 45, GFXFF);
          } else {
            M5.Lcd.drawNumber(sensorDifMin, 252, 45, GFXFF);
          }
...
// BG SECTION
          ...
          if ( smaller_font ) {
            M5.Lcd.setFreeFont(FSSB18);
            M5.Lcd.drawString(sensSgvStr, 0, 135, GFXFF);
          } else {
            M5.Lcd.setFreeFont(FSSB24);
            M5.Lcd.drawString(sensSgvStr, 0, 125, GFXFF);
          }
...
//            drawArrow(0 + tw + 25, 125 + 40, 10, arrowAngle + 85, 40, 40, glColor);      //  (x+tw+25, y+40, ...)
          ...
          //drawArrow(0+tw+40, 120+40, 10, 135+85, 40, 40, TFT_MAGENTA);
          //drawArrow(0+tw+40, 120+40, 10, -135+85, 40, 40, TFT_CYAN);
...
//          M5.Lcd.fillRect(0, 220, 320, 20, TFT_RED);
            M5.Lcd.fillRect(60, 202, 60, 18, TFT_RED);      // RECTANGLE SNOOZE BAR BUTTON
...
//                M5.Lcd.fillRect(0, 220, 320, 20, TFT_YELLOW);
                  M5.Lcd.fillRect(60, 202, 60, 18, TFT_YELLOW);      // RECTANGLE SNOOZE BAR BUTTON
...
//                M5.Lcd.drawString(tmpStr, 159-stw/2, 220, GFXFF);
                  ...
                  if( sensorDifMin>=cfg.snd_no_readings ) {
                    // yellow warning state
                    // M5.Lcd.fillRect(110, 220, 100, 20, TFT_DARKGREY);
...
//                        delay(1000);
        ...
        String errstr = String("." + String(httpCode));
      ...
      String errstr = String("." + String(http.errorToString(httpCode).c_str()));
      Serial.println(errstr);
      M5.Lcd.setCursor(0, 23);
      M5.Lcd.setTextSize(1);
      M5.Lcd.setFreeFont(FSSB12);
...
//    delay(1000);
//    M5.Lcd.fillRoundRect(0, 220, 170, 30, 0, TFT_BLACK);      // MASK RECTANGLE  (x, y, widht, height, corner)
//    M5.Lcd.setFreeFont(FMB9);
//    M5.Lcd.setTextColor(BLUE);
//    M5.Lcd.setCursor(100, 235);
//    M5.Lcd.setTextSize(1);
//    M5.Lcd.print("WiFi: ");
